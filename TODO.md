...
- [x] **Task 0.2: Project Structure and Tooling**
    ...
    - [x] Choose and set up a task management tool (e.g., Trello, Jira, GitHub Issues/Projects).
- [x] **Task 0.3: Initial Backend Project Setup (Node.js/Express)**
...
- [x] **Task 3: API Development - Admin Functionality**
    - [x] Endpoints for:
...
- [x] **Task 5: API Development - Student Functionality (for Mobile App)**
    - [x] Endpoints for:
        ...
        - [~] Marking attendance for a session:
            - [x] Input: class_id, session_id, current Wi-Fi SSID, current Bluetooth Beacon ID.
            - [x] Logic:

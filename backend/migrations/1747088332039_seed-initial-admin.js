...
exports.up = async (pgm) => {
  ...
  const insertSql = 'INSERT INTO users (email, password_hash, first_name, last_name, role) VALUES ($1, $2, $3, $4, $5) ON CONFLICT (email) DO NOTHING;';
  await pgm.db.query(insertSql, [ADMIN_EMAIL, passwordHash, ADMIN_FIRST_NAME, ADMIN_LAST_NAME, ADMIN_ROLE]);
